...
type GridAlignment = string | undefined

type Column = any & {headerAlign: GridAlignment, align: GridAlignment}
...
const Team = () => {
    ...
    const columns: Column[] = [
        ...
        {field: "access", headerName: "Access Level", flex: 1, renderCell: ({row}:any) => 
        { 
            return (
            <Box width="60%" 
            m="0 auto" 
